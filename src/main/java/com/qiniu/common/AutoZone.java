 ...
 */
public final class AutoZone extends com.qiniu.common.Zone {
     ...
     */
    private Map<String, com.qiniu.common.Zone> inferDomainsMap;
     ...
     * 通过 API 接口查询上传域名
     */
    private UCRet getZoneJson(ZoneIndex index) throws com.qiniu.common.QiniuException {
     ...
     * @return 机房域名信息
     */
    public ZoneInfo queryZoneInfo(com.qiniu.common.ZoneReqInfo zoneReqInfo) {
        try {
     ...
     */
    @Override
    public String getUpHttp(com.qiniu.common.ZoneReqInfo zoneReqInfo) {
     ...
     */
    @Override
    public String getUpBackupHttp(com.qiniu.common.ZoneReqInfo zoneReqInfo) {
        ZoneInfo info = queryZoneInfo(zoneReqInfo);
        if (info == null) {
            return "";
        }
     ...
     */
    @Override
    public String getUpIpHttp(com.qiniu.common.ZoneReqInfo zoneReqInfo) {
        ZoneInfo info = queryZoneInfo(zoneReqInfo);
        if (info == null) {
            return "";
        }
     ...
     */
    @Override
    public String getIovipHttp(com.qiniu.common.ZoneReqInfo zoneReqInfo) {
        ZoneInfo info = queryZoneInfo(zoneReqInfo);
        if (info == null) {
            return "";
        }
     ...
     */
    @Override
    public String getUpHttps(com.qiniu.common.ZoneReqInfo zoneReqInfo) {
        ZoneInfo info = queryZoneInfo(zoneReqInfo);
        if (info == null) {
            return "";
        }
     ...
     */
    @Override
    public String getUpBackupHttps(com.qiniu.common.ZoneReqInfo zoneReqInfo) {
        ZoneInfo info = queryZoneInfo(zoneReqInfo);
        if (info == null) {
            return "";
        }
     ...
     */
    @Override
    public String getUpIpHttps(com.qiniu.common.ZoneReqInfo zoneReqInfo) {
        ZoneInfo info = queryZoneInfo(zoneReqInfo);
        if (info == null) {
            return "";
        }
     ...
     */
    @Override
    public String getIovipHttps(com.qiniu.common.ZoneReqInfo zoneReqInfo) {
        ZoneInfo info = queryZoneInfo(zoneReqInfo);
        if (info == null) {
            return "";
        }
     ...
     */
    @Override
    public String getRsHttp(com.qiniu.common.ZoneReqInfo zoneReqInfo) {
        ZoneInfo info = queryZoneInfo(zoneReqInfo);
        if (info == null) {
            return super.getRsHttp();
        }
        com.qiniu.common.Zone zone = this.inferDomainsMap.get(info.upHttp);
        if (zone != null) {
     ...
     */
    @Override
    public String getRsHttps(com.qiniu.common.ZoneReqInfo zoneReqInfo) {
        ZoneInfo info = queryZoneInfo(zoneReqInfo);
        if (info == null) {
     ...
     */
    @Override
    public String getRsfHttp(com.qiniu.common.ZoneReqInfo zoneReqInfo) {
        ZoneInfo info = queryZoneInfo(zoneReqInfo);
        if (info == null) {
     ...
     */
    @Override
    public String getRsfHttps(com.qiniu.common.ZoneReqInfo zoneReqInfo) {
        ZoneInfo info = queryZoneInfo(zoneReqInfo);
        if (info == null) {
    ...
    @Override
    public String getApiHttp(com.qiniu.common.ZoneReqInfo zoneReqInfo) {
        ZoneInfo info = queryZoneInfo(zoneReqInfo);
        if (info == null) {
